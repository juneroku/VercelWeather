...
const WeatherIcon = ({ code = 0, size = 36 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24">
    ...
    <g stroke="#ffd1dc" strokeWidth="1.7" strokeLinecap="round"><path d="M12 2.8v3M12 18.2v3M2.8 12h3M18.2 12h3M5 5l2.2 2.2M17 17l2.2 2.2M19 5l-2.2 2.2M7 17L4.8 19.2"/></g>
  </svg>
);
    ...
    <div className="page-grid">
      ...
      <aside className="card" style={{alignSelf:'start'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'repeat(2,minmax(0,1fr))',gap:10,margin:'12px 0 14px'}}>
          {PRESETS.map(p=>(
            <button key={p.key} className="btn" onClick={()=>setCoords(p)}
